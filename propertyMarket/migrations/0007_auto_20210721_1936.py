...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('propertyMarket', '0006_auto_20210721_1845'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='propertyMarket.property', verbose_name='Property it belongs to')),
            ],
        ),
        migrations.CreateModel(
            name='PropertyImage',
            fields=[
                ...
                ('property', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='propertyMarket.property', verbose_name='Property it belongs to')),
            ],
        ),
