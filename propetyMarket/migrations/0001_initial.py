    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('villa', 'villa'), ('serviced apartment', 'serviced apartment'), ('office', 'office'), ('twin house', 'twin house'), ('clinic', 'clinic'), ('pent house', 'pent house'), ('duplex', 'duplex'), ('Industrial', 'Industrial'), ('chalet', 'chalet'), ('studio', 'studio'), ('town house', 'town house'), ('apartment', 'apartment'), ('retail', 'retail'), ('restaurant', 'restaurant')], max_length=100, verbose_name='Property Type')),
