    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(blank=True, null=True, upload_to='GoldMark/images/Agencies/profiles/', verbose_name='Bank image')),
            ],
        ),
        migrations.CreateModel(
            name='Agent',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('Agency', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='GoldMark.agency', verbose_name='Agency the agent belongs to')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('garage', models.IntegerField(verbose_name='number of garage places')),
                ('Agent', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='GoldMark.agent', verbose_name='Agency')),
                ('CompoundProperty', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='GoldMark.compoundproperty', verbose_name='Compound it belongs to')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('property', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='GoldMark.residentialproperty', verbose_name='Property it belongs to')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('image', models.ImageField(upload_to='GoldMark/images/properties/compound/', verbose_name='Image location')),
                ('Company', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='GoldMark.company', verbose_name='Company it belongs to')),
                ('property', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='GoldMark.compoundproperty', verbose_name='Property it belongs to')),
            ],
        ),
        migrations.AddField(
            model_name='compoundproperty',
            name='location',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='GoldMark.location', verbose_name='Location'),
        ),
        migrations.CreateModel(
            name='CommercialPropertyImage',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('image', models.ImageField(upload_to='GoldMark/images/properties/commercial/', verbose_name='Image location')),
                ('property', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='GoldMark.commercialproperty', verbose_name='Property it belongs to')),
            ],
        ),
        migrations.AddField(
            model_name='commercialproperty',
            name='CompoundProperty',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='GoldMark.compoundproperty', verbose_name='Compound it belongs to'),
        ),
        migrations.AddField(
            model_name='commercialproperty',
            name='location',
