...
class Developer(models.Model):
    ...
    image = models.ImageField(upload_to='GoldMark/images/Agencies/profiles/', verbose_name='Agency logo',
...
class Property(models.Model):
    ...
    video = models.FileField(upload_to='GoldMark/images/properties/videos/', verbose_name='property video',
                             blank=True, null=True)
    ...
    image = models.ImageField(upload_to='GoldMark/images/properties/residential/profiles',
